...
import { AvatarV5ProductionScene } from "@/components/avatar-v5-production/avatar-v5-scene";
...
export default function AvatarV5ProductionStudio({
  config,
  className,
  presentation = false,
}: {
  ...
  return (
    <div
      ref={containerRef}
      className={cx(
        "relative isolate h-[34rem] min-h-[28rem] w-full min-w-0 max-w-full overflow-hidden rounded-[32px] border border-white/10 bg-[#0b1018] lg:h-[43rem]",
        className,
      )}
    >
      <Canvas
